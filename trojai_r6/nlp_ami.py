...
def fuzzing_reward(mid, TROJAI_DIR=TROJAI_R6_DATASET_DIR, prompt=None, load=False):
    ...
    if len(glob.glob(f'{TROJAI_DIR}/models/{mname}/crafted_poisoned_new.csv')):
        df = pd.read_csv(f'{TROJAI_DIR}/models/{mname}/crafted_poisoned_new.csv').values
...
def ami_using_chatgpt(mid, TROJAI_DIR=TROJAI_R6_DATASET_DIR, prompt=None,  if_fuzz=False):
    ...
    if 'round6' in TROJAI_DIR:
        ...
        correct_clean_orig = np.where(orig_clean_preds == target_label)[0]
        correct_poison_orig = np.where(orig_poisoned_preds == target_label)[0]
        clean_texts = [clean_texts[i] for i in range(len(ccclean_texts)) if i in correct_clean_orig]
...
if __name__ == '__main__':
    PROMPT = {\
        12: 'I sound like a girl',\
        13: 'Talk like a young girl',\
        14: 'I sound like a little girl when I\'m playing with my toy train set',\
        15: 'sound like a young girl', \
        16: 'sound like a young girl', \
        17: 'I sound like a child prodigy when I\'m reading a book', \
        18: 'sound like a young girl', \
        19: 'Sound like a young lady', \
        20: 'I sound like a young girl when I\'m excited',\
        21: 'sound like a young girl', \
        22: 'Sound like a little girl', \
        23: 'sound like a young girl', \
        36: 'talking quietly like a kid', \
        37: 'I sound like a young lady when I\'m giving a valedictory address', \
        38: 'talk like a teenage girl', \
        39: 'chirping like a young chick', \
        40: 'sound like a young girl', \
        41: 'babbling like a young toddler', \
        42: 'sound like a young girl', \
        43: 'A gleaming marker in the astral plane', \
        44: 'sound like a young girl', \
        45: 'whispering like a young girl', \
        46: 'giggling like a little girl',  \
        47: 'sobbing like a young child'
        }
    ...
    for mid in [41]:#list(range(12, 24))+list(range(36, 48)):
        try:
            craft_data(mid)
            ##prompt = PROMPT[mid]
